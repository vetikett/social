...
$friendslist = $query->getFriends($inlogged_user->id);
?>
    <div class="u_content">
        <div class="up_info">
            <img class="up_img" src="../<?php echo $inlogged_user->user_img; ?>">
            <div class="up_content">
                <p class="up_username"><?php echo $inlogged_user->username; ?></p>
                <div class="up_currstatus"><?php echo $inlogged_user->user_status; ?></div>
        ...
        <div class="up_friendlist">
            <h2><?php echo $inlogged_user->username; ?>'s friends:</h2>
            <?php
